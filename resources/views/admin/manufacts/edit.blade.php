...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            @endif
            <h3>{{ trans('admin.manufact.edit') }} {{ $manufact['name_' . LaravelLocalization::getCurrentLocale()] }}</h3>
            {!! Form::model($manufact, ['method'=>'PATCH', 'action'=>['ManufactController@update', $manufact->id], 'files'=>true]) !!}
                ...
                <div class="form-group">
                    ...
                    <br>
                    <img src="{{ checkImage($manufact->icon, 'imagesManufacts') }}" alt="" width="100px" height="100px">
