            ...
            <div class="col-md-4">
                <div class="header-right">
                    <ul class="list-unstyled list-inline">
                        ...
                        <li class="dropdown dropdown-small">
                            <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" href="#"><span class="key">language :</span>{{ LaravelLocalization::getCurrentLocaleName() }}<span class="value"></span><b class="caret"></b></a>
                            <ul class="dropdown-menu">
...
<div class="site-branding-area">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <div class="logo">
                    <h1><a href=""><img src="{{ checkImage(setting()->logo, '/imagesSetting/', 'logo.png')}}"></a></h1>
                </div>
            </div>
