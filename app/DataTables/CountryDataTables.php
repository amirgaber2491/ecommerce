    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('edit', function ($model){
                $edit = '<a href="'. route('country.edit', $model->id) .'" class="btn btn-info">' . '<i class="fa fa-edit"></i>' . '</a>';
                return $edit;
            })
            ->addColumn('delete', function ($model){
                $edit = "<form action='". route('country.destroy', $model->id) ."' method='POST'>".
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters([
                ...
                'buttons'    => [
                    [
                        'text'      => '<i class="fa fa-plus"></i> '. trans('admin.country.add'),
                        'action'=>'function(){
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'name'  => 'countryName_ar',
                'data'  => 'countryName_ar',
                'title' => trans('admin.country.name_ar'),
            ],
            [
                'name'  => 'countryName_en',
                'data'  => 'countryName_en',
                'title' => trans('admin.country.name_en'),
            ],
            [
                'name'  => 'created_at',
                'data'  => 'created_at',
