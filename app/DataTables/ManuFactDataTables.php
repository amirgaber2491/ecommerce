    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('edit', function ($model){
                $edit = '<a href="'. route('manufact.edit', $model->id) .'" class="btn btn-info">' . '<i class="fa fa-edit"></i>' . '</a>';
                return $edit;
            })
            ->addColumn('delete', function ($model){
                $edit = "<form action='". route('manufact.destroy', $model->id) ."' method='POST'>".
            ...
            ->parameters([
                ...
                'buttons'    => [
                    [
                        ...
                        'action'=>'function(){
                            window.location.href = "'. route('manufact.create') .'"
                        }',
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'name'  => 'contact_name',
                'data'  => 'contact_name',
                'title' => trans('admin.manufact.contact'),
            ],
            [
                'name'  => 'created_at',
                'data'  => 'created_at',
