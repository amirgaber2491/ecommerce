    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('edit', function ($model){
                $edit = '<a href="'. route('city.edit', $model->id) .'" class="btn btn-info">' . '<i class="fa fa-edit"></i>' . '</a>';
                return $edit;
            })
            ->addColumn('delete', function ($model){
                $edit = "<form action='". route('city.destroy', $model->id) ."' method='POST'>".
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters([
                ...
                'buttons'    => [
                    [
                        'text'      => '<i class="fa fa-plus"></i> '. trans('admin.city.add'),
                        'action'=>'function(){
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'name'  => 'cityName_ar',
                'data'  => 'cityName_ar',
                'title' => trans('admin.city.name_ar'),
            ],
            [
                'name'  => 'cityName_en',
                'data'  => 'cityName_en',
                'title' => trans('admin.city.name_en'),
            ],
            [
                'name'  => 'country_id',
                'data'  => 'country_id',
