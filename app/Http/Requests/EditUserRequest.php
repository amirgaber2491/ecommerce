...
class EditUserRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'email'=>'required | string | max:255 | email | unique:admins,email,' . $this->user,
    ...
    {
        return [
            'name.required'=> trans('admin.validation.user.name.required'),
            'name.string'=>trans('admin.validation.user.name.string'),
            'name.min'=>trans('admin.validation.user.name.min'),
            'name.max'=>trans('admin.validation.user.name.max'),
